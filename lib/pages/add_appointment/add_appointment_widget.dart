                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<AppointmentsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<AppointmentsRecord> timeAppointmentsRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final timeAppointmentsRecord =
                              timeAppointmentsRecordList.isNotEmpty
                                  ? timeAppointmentsRecordList.first
                                  : null;
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<AppointmentsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<AppointmentsRecord> dateAppointmentsRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final dateAppointmentsRecord =
                              dateAppointmentsRecordList.isNotEmpty
                                  ? dateAppointmentsRecordList.first
                                  : null;
                          return TextFormField(
                      ...
                      child: StreamBuilder<List<AppointmentsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<AppointmentsRecord>
                              buttonAppointmentsRecordList = snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              final appointmentsCreateData =
                                ...
                                hospitalName:
                                    _model.hospitalNameController.text,
                              ...
                              context.pushNamed('appointmentScheduler');
                            },
                            text: 'Save Changes',
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<AppointmentsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<AppointmentsRecord>
                              hospitalNameAppointmentsRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final hospitalNameAppointmentsRecord =
                              hospitalNameAppointmentsRecordList.isNotEmpty
                                  ? hospitalNameAppointmentsRecordList.first
                                  : null;
                          return TextFormField(
