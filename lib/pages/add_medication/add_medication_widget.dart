...
class AddMedicationWidget extends StatefulWidget {
  const AddMedicationWidget({Key? key}) : super(key: key);
...
class _AddMedicationWidgetState extends State<AddMedicationWidget> {
  ...
  void initState() {
    ...
    _model.timesadayController ??= TextEditingController();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                controller: _model.timesadayController,
                textCapitalization: TextCapitalization.words,
                obscureText: false,
                decoration: InputDecoration(
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator:
                    _model.timesadayControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator: _model.timeControllerValidator.asValidator(context),
              ),
            ),
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    final pillRemainderCreateData =
                        createPillRemainderRecordData(
                      name: _model.nameController.text,
                      time: _model.timeController.text,
                      frequencyPerday: _model.timeController.text,
                    );
                    await PillRemainderRecord.collection
                        .doc()
                        .set(pillRemainderCreateData);

                    context.pushNamed('pillRemainder');
                  },
                  text: 'Save Changes',
